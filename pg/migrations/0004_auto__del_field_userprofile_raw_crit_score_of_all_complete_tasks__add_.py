...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.raw_crit_score'
        db.add_column(u'pg_userprofile', 'raw_crit_score',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.raw_crit_score'
        db.delete_column(u'pg_userprofile', 'raw_crit_score')
    ...
    models = {
        ...
        u'pg.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'raw_crit_score': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
