...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field priority_choices on 'Task'
        m2m_table_name = db.shorten_name(u'pg_task_priority_choices')
        ...
        db.create_unique(m2m_table_name, ['task_id', 'prioritychoice_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field priority_choices on 'Task'
        db.delete_table(db.shorten_name(u'pg_task_priority_choices'))
