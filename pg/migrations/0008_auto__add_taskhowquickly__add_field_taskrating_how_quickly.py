...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskHowQuickly'
        db.create_table(u'pg_taskhowquickly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'pg', ['TaskHowQuickly'])

        # Adding field 'TaskRating.how_quickly'
        db.add_column(u'pg_taskrating', 'how_quickly',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pg.TaskHowQuickly'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TaskHowQuickly'
        db.delete_table(u'pg_taskhowquickly')

        # Deleting field 'TaskRating.how_quickly'
        db.delete_column(u'pg_taskrating', 'how_quickly_id')
