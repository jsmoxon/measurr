...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PriorityChoice', fields ['key']
        db.delete_unique(u'pg_prioritychoice', ['key'])


    def backwards(self, orm):
        # Adding unique constraint on 'PriorityChoice', fields ['key']
        db.create_unique(u'pg_prioritychoice', ['key'])
