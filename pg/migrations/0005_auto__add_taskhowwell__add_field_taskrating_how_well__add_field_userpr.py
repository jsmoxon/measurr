...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskHowWell'
        db.create_table(u'pg_taskhowwell', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'pg', ['TaskHowWell'])

        # Adding field 'TaskRating.how_well'
        db.add_column(u'pg_taskrating', 'how_well',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pg.TaskHowWell'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.raw_how_well_score'
        db.add_column(u'pg_userprofile', 'raw_how_well_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.avg_how_well_score'
        db.add_column(u'pg_userprofile', 'avg_how_well_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TaskHowWell'
        db.delete_table(u'pg_taskhowwell')

        # Deleting field 'TaskRating.how_well'
        db.delete_column(u'pg_taskrating', 'how_well_id')

        # Deleting field 'UserProfile.raw_how_well_score'
        db.delete_column(u'pg_userprofile', 'raw_how_well_score')

        # Deleting field 'UserProfile.avg_how_well_score'
        db.delete_column(u'pg_userprofile', 'avg_how_well_score')
