...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TaskHowQuickly', fields ['name']
        db.delete_unique(u'pg_taskhowquickly', ['name'])

        # Adding field 'TaskHowQuickly.key'
        db.add_column(u'pg_taskhowquickly', 'key',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskHowQuickly.key'
        db.delete_column(u'pg_taskhowquickly', 'key')

        # Adding unique constraint on 'TaskHowQuickly', fields ['name']
        db.create_unique(u'pg_taskhowquickly', ['name'])
    ...
    models = {
        ...
        u'pg.prioritychoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        u'pg.taskhowquickly': {
            'Meta': {'object_name': 'TaskHowQuickly'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'pg.taskrating': {
            ...
            'how_quickly': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pg.TaskHowQuickly']", 'null': 'True', 'blank': 'True'}),
