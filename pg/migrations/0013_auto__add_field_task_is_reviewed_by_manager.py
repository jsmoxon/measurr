...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.is_reviewed_by_manager'
        db.add_column(u'pg_task', 'is_reviewed_by_manager',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.is_reviewed_by_manager'
        db.delete_column(u'pg_task', 'is_reviewed_by_manager')
    ...
    models = {
        ...
        u'pg.task': {
            ...
            'is_reviewed_by_manager': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
