...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PriorityChoice.key'
        db.add_column(u'pg_prioritychoice', 'key',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PriorityChoice.key'
        db.delete_column(u'pg_prioritychoice', 'key')
    ...
    models = {
        ...
        u'pg.prioritychoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
