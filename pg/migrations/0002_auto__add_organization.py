...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pg_organization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal(u'pg', ['Organization'])

        # Adding M2M table for field user_profile on 'Organization'
        m2m_table_name = db.shorten_name(u'pg_organization_user_profile')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm[u'pg.organization'], null=False)),
            ('userprofile', models.ForeignKey(orm[u'pg.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['organization_id', 'userprofile_id'])


    def backwards(self, orm):
        # Deleting model 'Organization'
        db.delete_table(u'pg_organization')

        # Removing M2M table for field user_profile on 'Organization'
        db.delete_table(db.shorten_name(u'pg_organization_user_profile'))
