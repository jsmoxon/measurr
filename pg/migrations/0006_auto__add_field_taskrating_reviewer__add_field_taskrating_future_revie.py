...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskRating.reviewer'
        db.add_column(u'pg_taskrating', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pg.UserProfile'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TaskRating.future_review_date'
        db.add_column(u'pg_taskrating', 'future_review_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field priority_choices on 'TaskRating'
        m2m_table_name = db.shorten_name(u'pg_taskrating_priority_choices')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('taskrating', models.ForeignKey(orm[u'pg.taskrating'], null=False)),
            ('prioritychoice', models.ForeignKey(orm[u'pg.prioritychoice'], null=False))
        ))
        db.create_unique(m2m_table_name, ['taskrating_id', 'prioritychoice_id'])


    def backwards(self, orm):
        # Deleting field 'TaskRating.reviewer'
        db.delete_column(u'pg_taskrating', 'reviewer_id')

        # Deleting field 'TaskRating.future_review_date'
        db.delete_column(u'pg_taskrating', 'future_review_date')

        # Removing M2M table for field priority_choices on 'TaskRating'
        db.delete_table(db.shorten_name(u'pg_taskrating_priority_choices'))
    ...
    models = {
        ...
        u'pg.taskrating': {
            ...
            'future_review_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'how_well': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pg.TaskHowWell']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'long_review': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'priority_choices': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['pg.PriorityChoice']", 'null': 'True', 'blank': 'True'}),
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pg.UserProfile']", 'null': 'True', 'blank': 'True'})
        },
        u'pg.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'avg_crit_score': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'avg_how_well_score': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'department': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'raw_crit_score': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'raw_how_well_score': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
